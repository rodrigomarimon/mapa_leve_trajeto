...
<head>
    ...
    <title>Upload de CSV e Geração de Mapa de Trajeto com Mapa de Calor</title>
    <style>
        body {
...
<body>
    <h1>Upload de CSV e Geração de Mapa de Trajeto com Mapa de Calor</h1>
    <form action="/uploads" method="post" enctype="multipart/form-data">
        <input type="file" name="file" accept=".csv">
        <input type="submit" value="Enviar e Gerar Mapa">
    </form>
...
def upload_file():
    ...
    if file and file.filename.endswith('.csv'):
        ...
        if df.empty:
            return 'Não há pontos válidos para gerar o mapa.'
